...
export default function GamePage() {
      ...
      <div class={styles.loading_container}>
        <div class={styles.loading_screen}>
          <div class={styles.loading_message}>
            ...
            <div>
              Waiting for game to start. Click the link below to copy the
              spectator link.
  ...
  const ReconnectScreen = () => {
    return (
      <div class={styles.loading_container}>
        <div class={styles.loading_screen}>
          <div class={styles.loading_message}>
            One player has disconnected. Waiting for reconnection.
          </div>
        </div>
        <Show when={copied()}>{copiedModal()}</Show>
      </div>
  ...
  return (
    <div>
      <Show when={gamePhase() != game_phases.DRAFTING}>
        {LoadingMenu()};
      </Show>
      <Show when={gamePhase() == game_phases.DRAFTING}>
        <MainApp
